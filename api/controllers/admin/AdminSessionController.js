    ...
    adminLogin: async (req, res) => {
        try {
            ...
            if (validateResult.error) {
                return ResponseService.json(res, ConstantService.responseCode.BAD_REQUEST, validateResult.error.message);
            }
            ...
            return ResponseService.json(res, ConstantService.responseCode.INTERNAL_SERVER_ERROR, ConstantService.responseMessage.ERR_MSG_ISSUE_IN_ADMIN_LOGIN_API);
        }
    },
    ...
    adminAccessTokenLogin:
        async (req, res) => {
            try {
                ...
                LogService.error(exception);
                return ResponseService.json(res, ConstantService.responseCode.INTERNAL_SERVER_ERROR, ConstantService.responseMessage.ERR_MSG_ISSUE_IN_ADMIN_ACCESS_TOKEN_LOGIN_API);
            }
        },
    ...
    logoutAdmin:
        async (req, res) => {
            ...
            try {
                ...
                LogService.error(exception);
                return ResponseService.json(res, ConstantService.responseCode.INTERNAL_SERVER_ERROR, ConstantService.responseMessage.ERR_MSG_ISSUE_IN_ADMIN_LOGOUT_API);
            }
