...
module.exports = {
    ...
    datastores: {
        ...
        default: {
            ...
            port: process.env.DATASTORE_PORT | 0,
            charset: 'utf8mb4',
            timezone: 'utc',
            pool: true,
            connectionLimit: process.env.DATASTORE_CONNECTION_LIMIT | 0,
    ...
    security: {
        ...
        cors: {
            allRoutes: true,
            allowOrigins: '*',
            allowRequestHeaders: 'Content-Type, authorization, access-control-allow-origin, utcoffset, Origin, X-Auth-Token, source, distinctid, currency',
